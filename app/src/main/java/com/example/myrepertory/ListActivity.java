...
public class ListActivity extends Activity {
    ...
    public void displayList() {     //listにデータを表示する
        nameList = (ListView) this.findViewById(R.id.listView);
    ...
    public void searchSort(String search, String orderBy, boolean edit) {
        ListView nameList = (ListView) this.findViewById(R.id.listView);
        ArrayList<Music> list = new ArrayList<Music>();
        Cursor cursor = null;
        try {
            if (edit) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchSpin = (Spinner) this.findViewById(R.id.spinner);
        ...
        sortSpin = (Spinner) this.findViewById(R.id.spinner2);
        ...
        searchEdit = (EditText) this.findViewById(R.id.editText);
